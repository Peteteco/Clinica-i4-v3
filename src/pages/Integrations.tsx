...
export default function Integrations() {
  ...
  useEffect(() => {
    ...
    const checkConnection = async () => {
      try {
        ...
        const response = await fetch("https://n8n.main.iseed.cloud/webhook/verificar-conexao", {
          method: "POST",
          headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("https://n8n.main.iseed.cloud/webhook/criar-instancia-cliente", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeleteInstance = async () => {
    ...
    try {
      ...
      const response = await fetch("https://n8n.main.iseed.cloud/webhook/apagar-instancia", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    },
  ...
  const handleListInstance = async () => {
    ...
    try {
      ...
      const response = await fetch("https://n8n.main.iseed.cloud/webhook/listar-instancia", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleGenerateQRCode = async () => {
    ...
    try {
      ...
      const response = await fetch("https://n8n.main.iseed.cloud/webhook/gerar-qrcode", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
