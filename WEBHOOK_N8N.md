...
## 📍 Endpoint
```
POST https://n8n.main.iseed.cloud/webhook/labz-criar-agenda
```
...
```bash
curl -X POST https://n8n.main.iseed.cloud/webhook/labz-criar-agenda \
...
```javascript
fetch('https://n8n.main.iseed.cloud/webhook/labz-criar-agenda', {
  method: 'POST',
...
```env
VITE_WEBHOOK_URL=https://n8n.main.iseed.cloud/webhook/labz-criar-agenda
```

E usar no código:

```typescript
const webhookUrl = import.meta.env.VITE_WEBHOOK_URL || 'https://n8n.main.iseed.cloud/webhook/labz-criar-agenda';
...
```typescript
await fetch('https://n8n.main.iseed.cloud/webhook/labz-criar-agenda', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
